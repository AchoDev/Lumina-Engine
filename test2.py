...
# mouse_collider.add_child(Square(0, 0, 5, 0.5, orange)).add_component(Rigidbody()).fixed_rotation = False
# mouse_collider.add_child(Square(-4.5, 0, 0.5, 1, orange)).add_component(Rigidbody()).fixed_rotation = False
